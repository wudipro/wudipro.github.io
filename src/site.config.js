...
export const site = {
  ...
  description:
    "Di Wu holds a Ph.D. in Computer Science and studies blockchain security, " +
    "decentralized systems, payment channels, DeFi, and cross-chain protocols. " +
    "He is currently seeking postdoctoral research opportunities.",

  // Shorter line for link previews (WeChat, X, LinkedIn, Slack).
  socialDescription:
    "Ph.D. in Computer Science specializing in blockchain and systems " +
    "security; currently seeking postdoctoral research opportunities.",
  ...
  seo: {
    ...
    location: { locality: "Hangzhou", country: "CN" },
